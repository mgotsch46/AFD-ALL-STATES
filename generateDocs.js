...
function fullAddr(d) {
  // Returns "123 Main St, Detroit, MI 48180" style from separate fields if zip present
  const zip = d.zip_code ? ', ' + d.zip_code : '';
  return d.property_address + zip;
}
...
function buildBuyerAcknowledgments(d) {
  const buyers = [d.buyer1_name, d.buyer2_name, d.buyer3_name, d.buyer4_name].filter(Boolean);
  const children = [
    heading('Important Buyer Acknowledgments \u2013 ' + fullAddr(d)),
    blank(20),
  ...
  const children = [
    ...
    new Table({
      ...
      rows: [
        ...
        new TableRow({ children: [cell('Property Address:', 3400, {bold:true}), cell(fullAddr(d), 6680)] }),
...
function buildBuyerContactInfo(d) {
  ...
  const children = [
    ...
    blank(40),
    p([r('Property Address: '), r(fullAddr(d), {bold:true})]),
    blank(30),
  ];
  buyers.forEach((b, i) => {
...
function buildDepositAgreement(d) {
  ...
  const children = [
    ...
    new Table({
      ...
      rows: [
        new TableRow({ children: [cell('Property Address:', 2800, {bold:true}), cell(fullAddr(d), 7280)] }),
...
function buildAsIsAddendum(d) {
  ...
  const children = [
    ...
    blank(20),
    p([r('This As-Is Condition and Due Diligence Addendum ("Addendum") is incorporated into and made part of the Agreement for Deed between '), r(buyers.join(' and '), {bold:true}), r(' ("Buyer") and '), r(d.seller_name, {bold:true}), r(' ("Seller") for the property located at '), r(fullAddr(d), {bold:true}), r(', dated '), r(d.doc_date, {bold:true}), r('.')]),
    blank(20),
    new Table({
...
function buildLeadPaint(d) {
  ...
  const children = [
    ...
    blank(20),
    p([r('Property Address: '), r(fullAddr(d), {bold:true, underline:true})]),
    blank(20),
    new Table({
      width: { size: FULL, type: WidthType.DXA }, columnWidths: [FULL],
      rows: [
...
function buildRadonDisclosure(d) {
  ...
  const children = [
    ...
    blank(20),
    p([r('Dwelling Unit Address: '), r(fullAddr(d), {bold:true})]),
    blank(20),
    new Table({
      width: { size: FULL, type: WidthType.DXA }, columnWidths: [FULL],
      rows: [
...
function buildMemorandum(d) {
  ...
  const children = [
    ...
    new Table({
      ...
      rows: [
        new TableRow({ children: [cell('Property Address:', 2400, {bold:true}), cell(fullAddr(d), 7680)] }),
...
function buildSellerDisclosure(d) {
  ...
  const children = [
    ...
    new Table({
      width: { size: FULL, type: WidthType.DXA }, columnWidths: [2400, 7680],
      rows: [
        new TableRow({ children: [cell('Property Address:', 2400, {bold:true, size:18}), cell(fullAddr(d), 7680, {size:18})] }),
